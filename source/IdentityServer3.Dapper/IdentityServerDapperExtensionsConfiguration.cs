...
{
    internal class IdentityServerDapperExtensionsConfiguration : IDapperExtensionsConfiguration
    {
        private DapperServiceOptions _option;
        ...
        public IClassMapper GetMap(Type entityType)
        {
            ...
            if (!_classMaps.TryGetValue(entityType, out map))
            {
                ...
                map = Activator.CreateInstance(mapType, new object[] { this._option }) as IClassMapper;
